...
export default function WhatsAppButton({ userName, businessName, locationName }: WhatsAppButtonProps) {
  const message = buildMessage({ userName, businessName, locationName });
  const href = `https://wa.me/255759229777?text=${encodeURIComponent(message)}`;
