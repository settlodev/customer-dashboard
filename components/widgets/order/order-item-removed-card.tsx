...
import { RemovedItems } from "@/types/orders/type";

interface OrderItemRemovedCardProps {
    item: RemovedItems;
    isValidImageUrl: (url: string) => boolean;
}

const OrderItemRemovedCard: React.FC<OrderItemRemovedCardProps> = ({
                                                         item,
                                                         isValidImageUrl
                                                     }) => {
...
export default OrderItemRemovedCard;
