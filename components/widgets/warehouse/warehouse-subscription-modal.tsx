    ...
    const fetchPackages = async () => {
      try {
        ...
        if (packageList.length === 1) {
          form.setValue(
            "warehouseSubscriptions.0.subscription",
            packageList[0].id,
          );
        }
  ...
  const handleCreateWarehouseInvoice = async (data: InvoiceFormData) => {
    ...
    try {
      const numberOfMonths =
        data.warehouseSubscriptions[0]?.numberOfMonths || 1;
      ...
      await onSubscribe(
        typeof selectedSubscriptionId === "string"
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center space-x-3 p-3 bg-primary-light rounded-lg">
            <div className="w-10 h-10 rounded-full bg-primary-light/100 flex items-center justify-center">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        {subscriptionPackages.length === 1 ? (
                          ...
                          <div className="border border-primary/200 rounded-lg p-4 bg-primary-light/50 relative">
                            {subscriptionPackages.map((item: any) => (
                              <div key={item.id} className="pr-8">
                                <div className="flex items-center justify-between mb-2">
                                  ...
                                  <Badge className="border-blue-200 text-primary">
