    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow">
        ...
        <div className="max-w-6xl mx-auto p-4 pt-6">
          {/* Show LoadingStates only for errors, not for loading */}
          {productsError && (
            <LoadingStates
              initialLoad={false}
              loading={false}
          ...
          {/* Always show ProductGrid - it handles its own loading state */}
          {!productsError && (
            <ProductGrid
              categorizedProducts={categorizedProducts}
              selectedCategory={selectedCategory}
          ...
          <div ref={loaderRef} className="w-full py-8 flex justify-center">
            {!productsInitialLoad && productsLoading && products.length > 0 && (
