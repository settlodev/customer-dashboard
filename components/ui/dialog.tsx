...
interface DialogContentProps
  ...
  /**
   * Override the default backdrop scrim. The unmodified default is a
   * heavy `bg-black/80`; pass something like
   * `bg-foreground/30 backdrop-blur-sm` for a softer focus scrim that
