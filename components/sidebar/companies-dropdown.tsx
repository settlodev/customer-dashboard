...
export const CompaniesDropdown = ({ data }: { data: BusinessPropsType }) => {
  ...
  const [selectedWarehouse, setSelectedWarehouse] = useState<Warehouses | null>(
    null,
  );
  ...
  return (
    <>
      <DropdownMenu
        open={loadingLocationId ? true : isOpen}
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {selectedLocation?.name || selectedWarehouse?.name}. This will
              reload the page.
            </DialogDescription>
          </DialogHeader>
