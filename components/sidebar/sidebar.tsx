  ...
  useEffect(() => {
    ...
    const fetchSubscription = async () => {
      try {
        ...
        // ✅ If token is invalid, redirect to login immediately
        ...
        {isLoading ? (
          ...
          <div className="p-4">
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-gray-400 mb-4">
                Your {menuTypeLabel.toLowerCase()} subscription has expired or
                is inactive. Please renew to access all features.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 text-center">
            ...
            <p className="text-sm text-gray-400">
              No menu items available for your {menuTypeLabel.toLowerCase()}{" "}
              subscription
            </p>
            <Link
...
export const MobileSidebar = ({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent
        side="left"
        className="w-64 p-0 bg-gray-50 dark:bg-gray-900"
      >
        <SidebarContent
          data={data}
          isMobile={true}
