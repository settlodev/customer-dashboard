...
export function ProductWithStockCSVDialog() {
  ...
  const handleSuccessClose = () => {
    toast({
      ...
      description: "Products and stock have been uploaded.",
    });
    resetForm();
    setIsOpen(false);
    setTimeout(() => window.location.reload(), 300);
        ...
        return (
          <>
            <DialogHeader className="space-y-1">
              ...
              <DialogDescription>
                Sit tight — we&apos;re importing your products and stock.
              </DialogDescription>
            </DialogHeader>
        ...
        return (
          <>
            <DialogHeader className="space-y-1">
              ...
              <DialogDescription>
                Your products and stock have been successfully imported.
              </DialogDescription>
            </DialogHeader>
          ...
          <>
            ...
            <div className="px-4 sm:px-6 pt-5 pb-3 border-b border-border shrink-0">
              <DialogHeader className="space-y-0.5">
                <DialogTitle className="text-base font-semibold">
                  Import Products with Stock
                </DialogTitle>
                <DialogDescription className="text-xs">
                  Upload a CSV file to bulk-import products and stock in one go.
                </DialogDescription>
              </DialogHeader>
            ...
            <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 space-y-3 min-h-0">
              ...
              <div className="space-y-1.5">
                ...
                {/* Compact drop zone — not tall, inline style */}
                <label
                  htmlFor="csv"
                  className={cn(
                  ...
                  <div className="min-w-0 flex-1">
                    {file ? (
                      ...
                      <>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Required: Product Name, Category, Variants, Price,
                          Stock info
                        </p>
                      </>
                    )}
              ...
              {validationResult?.isValid && productCount > 0 && (
                <div className="flex items-center gap-2 rounded-lg border border-emerald-200 dark:border-emerald-900 bg-emerald-50 dark:bg-emerald-950/30 px-3 py-2">
                  ...
                  <p className="text-sm text-emerald-700 dark:text-emerald-300">
                    Ready to upload <strong>{productCount}</strong> products
                    with stock.
                  </p>
                </div>
              )}
