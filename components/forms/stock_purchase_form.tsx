...
//   };
//
//   // Professional LPO Preview Component
//   const PreviewSection = () => {
//     const totalQuantity = getTotalQuantity();
//     const totalItems = getTotalItems();
//
//     return (
//       <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 print:bg-white print:relative print:z-auto">
//         <div className="bg-white dark:bg-gray-900 rounded-lg shadow-2xl max-w-6xl w-full max-h-[95vh] overflow-hidden print:shadow-none print:max-h-none print:overflow-visible">
//           <div className="flex flex-col h-full">
//             {/* Header */}
//             <div className="border-b px-6 py-4 bg-gray-50 dark:bg-gray-800 flex items-center justify-between print:hidden">
//               <div>
...
//                     </TabsList>
//
//                     {/* Professional LPO Document Tab */}
//                     <TabsContent value="document" className="mt-0">
//                       <div className="bg-white dark:bg-gray-800 border rounded-lg overflow-hidden print:border-0">
//                         {/* LPO Header */}
...
//                             </p>
//                             <p>
//                               2. Delivery must be made on or before the
//                               specified delivery date.
//                             </p>
//                             <p>
//                               3. All items must meet the specified quality
//                               standards and match the descriptions provided.
//                             </p>
//                             <p>
//                               4. Invoice should reference the purchase order
...
//
//                         {/* Footer */}
//                         <div className="px-8 py-4 bg-gray-900 dark:bg-gray-950 text-center">
...
//                 <p className="text-sm text-gray-600 dark:text-gray-400">
//                   Created on {format(new Date(), "PPP")}
//                 </p>
