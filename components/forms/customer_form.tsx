...
//   };
//
//   // Parse credit limit for submission (remove commas)
//   const parseCreditLimit = (value: string): string => {
...
//     const parsedValue = parseCreditLimit(formattedValue);
//
//     // Update the form value with the parsed value
//     form.setValue("creditLimit", parsedValue, {
//       shouldValidate: true,
//       shouldDirty: true,
//     });
//
...
//       const submitValues = {
//         ...values,
//         // Ensure credit limit is a number or undefined
//         creditLimit: values.creditLimit
//           ? parseFloat(parseCreditLimit(values.creditLimit))
//           : undefined,
//       };
//
//       if (item) {
...
//                       value={formatCreditLimit(field.value ?? "")}
...
//           </div>
//
//           {/* Allow Notifications - Full width on mobile, half on desktop */}
...
function CustomerForm({ item }: { item: Customer | null | undefined }) {
  ...
  const form = useForm<z.infer<typeof CustomerSchema>>({
    ...
    defaultValues: {
      ...
      email: item?.email ?? "",
      phoneNumber: item?.phoneNumber ?? "",
      // Now creditLimit should be a number or undefined
