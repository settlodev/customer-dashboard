...
const CartSidebar: React.FC<CartSidebarProps> = ({
  ...
  const hasUnlimitedStock = (item: any): boolean => {
    if (item.variants && item.variants.length > 0) {
      ...
      if (selectedVariant) {
        return (
          selectedVariant.trackingType === null &&
    ...
    return item.trackingType === null && item.availableStock === null;
  };
  ...
  const handleQuantityChange = (cartItemId: string, newQuantity: number) => {
    ...
    const cartItem = state.orderRequestitems.find(
    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          {/* Header */}
          <div
            className={`${businessType.primary} text-white p-4 flex justify-between items-center`}
          >
                    ...
                    >
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center justify-between mt-2">
                            <div className="flex items-center gap-2">
                              ...
                              <Input
                                ...
                                min="1"
                                max={
                                  !isUnlimitedStock && availableQuantity > 0
                                    ? availableQuantity
                                    : undefined
                                }
                                value={
                                ...
                                onBlur={() =>
                                  handleQuantityInputBlur(item.cartItemId)
                                }
                                onKeyPress={(e) =>
                          ...
                          {isInStock &&
                            (isUnlimitedStock || availableQuantity >= 10) && (
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateCustomerDetails({ firstName: e.target.value })
                        }
                        placeholder="John"
                        required
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateCustomerDetails({ lastName: e.target.value })
                        }
                        placeholder="Doe"
                        required
                        disabled={isSubmitting}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateCustomerDetails({ phoneNumber: e.target.value })
                      }
                  ...
                  <div>
                    <Label htmlFor="gender">
                      Gender <span className="text-red-500 font-medium">*</span>
                    </Label>
                    <Select
                      value={state.customerDetails.gender}
                      onValueChange={(
                        value: "MALE" | "FEMALE" | "UNDISCLOSED",
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateCustomerDetails({ emailAddress: e.target.value })
                      }
