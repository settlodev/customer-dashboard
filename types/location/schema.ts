...
export const LocationSchema = object({
    ...
    phone: string({ required_error: "Phone number is required" }).min(8, 'Phone number must be more than 8 characters').max(20, 'Phone number can not be more than 20 characters').refine(isValidPhoneNumber, {
