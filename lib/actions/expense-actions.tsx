...
export const fetchAllExpenses = async (): Promise<Expense[]> => {
  ...
  try {
    ...
    const expenseData = await apiClient.get(`/api/expenses/${location?.id}`);
...
export const createExpense = async (
  ...
  try {
    ...
    await apiClient.post(`/api/expenses/${location?.id}/create`, payload);
...
export const updateExpense = async (
  ...
  try {
    ...
    await apiClient.put(`/api/expenses/${location?.id}/${id}`, payload);
...
export const payExpense = async (
  ...
  try {
    await apiClient.post(`/api/expense-payments/${expenseId}/create`, payload);
    ...
    return parseStringify({
      responseType: "error",
      message:
        error.message ?? "Failed to pay for this expense. Please try again.",
      error: error instanceof Error ? error : new Error(String(error)),
    });
  }
