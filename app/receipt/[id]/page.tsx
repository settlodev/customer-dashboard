    ...
    <div className="min-h-screen bg-gray-100 mt-2 px-4 sm:px-0">
      <div className="max-w-2xl mx-auto">
        {orderData.paidAmount === orderData.amount ? (
          ...
          // Show a message when the order is still open
          // <div className="flex flex-col items-center justify-center min-h-[40vh] bg-white shadow-md rounded-lg p-6">
          //   <h2 className="text-lg font-semibold text-gray-700">Receipt Not Available</h2>
          //   <p className="text-sm text-gray-500 text-center mt-2">
          //     The receipt will be available once the order is closed.
          //   </p>
          // </div>
          <div
          id="receipt-content"
