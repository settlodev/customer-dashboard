...
const BusinessList = ({ businesses }: { businesses: Business[] }) => {
    ...
    const handleBusinessSelect = useCallback(async (selectedBusiness: Business, index: number) => {
        ...
        <section className="relative">
            ...
            <Card className="w-full mx-auto max-w-md mt-10 lg:mt-0 md:mt-0">
                <CardHeader className="text-center pb-2">
                    ...
                    <CardDescription>Get started by selecting your business</CardDescription>
                </CardHeader>
