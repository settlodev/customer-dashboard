      ...
      >
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-gray-600 mt-2">
            Your request to{" "}
            {formData.requestType === "delete" ? "delete" : "clear"} your data
        ...
        <div className="bg-blue-50 p-4 rounded-lg mb-6">
          <div className="flex">
            ...
            <div className="text-sm text-blue-700">
              ...
              <p>
                Your request will be reviewed within the next 7 days.
        ...
        <div className="border-t border-gray-200 pt-4 mt-4">
          ...
          <ul className="text-sm text-gray-600 space-y-2">
            ...
            <li>
              <span className="font-medium">Request ID:</span> REQ-
    ...
    <div className="max-w-2xl mx-auto p-6 mt-[80px] bg-white rounded-lg shadow-md">
      ...
      <div className="flex mb-8" aria-hidden="true">
        {[1, 2, 3].map((stepNumber) => (
          <div
            key={stepNumber}
            className={`flex-1 ${stepNumber !== 1 ? "relative" : ""}`}
          >
            {stepNumber !== 1 && (
              <div
                className={`h-1 absolute top-3 w-full -left-1/2 ${step >= stepNumber ? "bg-emerald-500" : "bg-gray-200"}`}
              ></div>
            )}
            <div
            ...
            <div className="bg-amber-50 p-4 rounded-lg my-6">
              <div className="flex">
                ...
                <div className="text-sm text-amber-700">
                  All data removal requests are subject to a 7-day review period
          ...
          <div className="mb-6">
            <div className="bg-red-50 p-4 rounded-lg mb-4" role="alert">
              <div className="flex">
                ...
                <div className="text-sm text-red-700">
                  ...
                  <p>
                    Please verify your identity by entering your password to
                    continue.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-6">
              ...
              <ul className="text-sm text-gray-600 space-y-2">
                ...
                <li>
                  <span className="font-medium">Review Period:</span> 7 working
                  days
                </li>
              </ul>
            </div>
