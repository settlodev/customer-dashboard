        ...
        <div className={`flex-1 space-y-4 md:p-8 pt-6`}>
            <div className={`flex items-center justify-between mb-2`}>
                ...
                <div className={`flex items-center space-x-2`}>
                    <Button>
                        <Link href={`/stocks/new`}>Add Inventory</Link>
                    </Button>
                </div>
            </div>
            {
                total > 0 || q != "" ? (
                    <Card x-chunk="data-table">
                        <CardHeader>
                            ...
                            <CardDescription>Manage Inventory in your business location</CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    (
                        <NoItems newItemUrl={`/stocks/new`} itemName={`Inventory`}/>
                    )
            }
        </div>
    );
