...
export default async function Page({ params }: { params: Params }) {
  ...
  return (
    <PageShell>
      ...
      />
      <PageHeader
        title={isNewItem ? "Add modifier group" : "Edit modifier group"}
        subtitle={
          isNewItem
            ? "Create a new reusable group of customer-facing tweaks."
            : "Update group details and manage its options."
        }
      />
