    ...
    return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card className={`shadow-md hover:shadow-lg transition-shadow ${cardColors.totalStock.bg} border-0`}>
          ...
          <CardContent>
            <div className="text-3xl font-bold" style={{ color: cardColors.totalStock.accent }}>
        ...
        <Card className={`shadow-md hover:shadow-lg transition-shadow ${cardColors.stockValue.bg} border-0`}>
          ...
          <CardContent>
            <div className="text-3xl font-bold" style={{ color: cardColors.stockValue.accent }}>
        ...
        <Card className={`shadow-md hover:shadow-lg transition-shadow ${cardColors.estimatedProfit.bg} border-0`}>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <div className="w-12 h-12 rounded-full flex items-center justify-center" 
              ...
              {cardColors.estimatedProfit.icon}
            </div>
            <CardTitle className="text-sm font-medium text-gray-600">
              Estimated Profit
            </CardTitle>
          ...
          <CardContent>
            <div className="text-3xl font-bold" style={{ color: cardColors.estimatedProfit.accent }}>
        ...
        <Card className={`shadow-md hover:shadow-lg transition-shadow ${cardColors.stockIntakes.bg} border-0`}>
          ...
          <CardContent>
            <div className="text-3xl font-bold" style={{ color: cardColors.stockIntakes.accent }}>
        ...
        <Card className={`shadow-md hover:shadow-lg transition-shadow ${cardColors.lowStock.bg} border-0`}>
          ...
          <CardContent>
            <div className="text-3xl font-bold" style={{ color: cardColors.lowStock.accent }}>
        ...
        <Card className={`shadow-md hover:shadow-lg transition-shadow ${cardColors.outOfStock.bg} border-0`}>
          ...
          <CardContent>
            <div className="text-3xl font-bold" style={{ color: cardColors.outOfStock.accent }}>
                  ...
                  <TableBody>
                    {getLowStockItems().map((item, index) => (
                      <TableRow key={item.stockName} className="hover:bg-yellow-50">
                        ...
                        <TableCell className="font-medium text-amber-600">{Intl.NumberFormat().format(item.remainingAmount)}</TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
                  ...
                  <TableBody>
                    {getOutOfStockItems().map((item, index) => (
                      <TableRow key={item.stockName} className="hover:bg-red-50">
                        ...
                        <TableCell className="font-medium text-red-600">{item.stockName} - {item.stockVariantName}</TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
