...
export const SelectBusiness = ({ businesses }: { businesses: Business[] }) => {
    ...
    return (<>
        ...
        <div className="container mx-auto flex flex-col items-center justify-center lg:flex-row">
            ...
            <div className="flex flex-col items-center justify-center overflow-hidden  text-center mt-6 lg:w-1/2">
                ...
                <div className="flex items-center justify-center lg:w-96 lg:h-96 ">
                    <Image src="/illustrator/selectbusiness.svg" alt="Settlo Logo" width={500} height={500} />
                </div>
            </div>

            <div className="flex items-center justify-center md:w-1/3">
                <div className="rounded-full border-1 border-gray-200 ">
                    <ul className="w-full flex flex-col gap-2 divide-y divide-gray-200 dark:divide-gray-700">
                        {business ?
